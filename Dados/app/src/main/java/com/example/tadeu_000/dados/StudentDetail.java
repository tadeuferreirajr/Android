...
public class StudentDetail extends ActionBarActivity implements android.view.View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextPIB = (EditText) findViewById(R.id.editTextPIB);
        ...
        editTextPIB.setText(String.valueOf(student.PIB));
    ...
    public void onClick(View view) {
        if (view == findViewById(R.id.btnSave)){
            StudentRepo repo = new StudentRepo(this);
            Student student = new Student();
            student.PIB = Integer.parseInt(editTextPIB.getText().toString());
